...
let () =
  ...
  let part1_fn, part2_fn =
    ...
    | 9 -> (Days.D9.part1, Days.D9.part2)
    | 10 -> (Days.D10.part1, Days.D10.part2)
    | 11 -> (Days.D11.part1, Days.D11.part2)
    | 12 -> (Days.D12.part1, Days.D12.part2)
    | 13 -> (Days.D13.part1, Days.D13.part2)
    | 14 -> (Days.D14.part1, Days.D14.part2)
    | 15 -> (Days.D15.part1, Days.D15.part2)
    | 16 -> (Days.D16.part1, Days.D16.part2)
    | 17 -> (Days.D17.part1, Days.D17.part2)
    | 18 -> (Days.D18.part1, Days.D18.part2)
